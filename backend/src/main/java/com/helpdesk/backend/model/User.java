...
@Entity
// Tabla "user" entrecomillada porque es reservada en varios motores (PostgreSQL incluido)
@Table(
    name = "\"user\"",
    uniqueConstraints = {
...
public class User {
  ...
  public User(Long id, UserRoles role, String name, String lastName, String email, String phone, String password, LocalDateTime createdAt) {
    this.id = id;
    this.role = role;
    this.name = name;
